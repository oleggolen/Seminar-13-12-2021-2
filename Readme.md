...
## История веток и коммитов и их сливание
Для этого воспользуемся командой _(git log --graph)_ 
...
для того что бы соеденить ветки нужно перейти на основную ветку в данном случае ветка **_master_**

 воспользуемся командой перехода (git checkout master)

 далее соеденим ветки master и readme c помощью команды (git merge (и название ветки))
