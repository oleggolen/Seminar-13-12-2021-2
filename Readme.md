...
Команда *git clone* создает новый репозитарий на основе оригинального (исходного) репозитария. Полная команда выглядит следующим образом: *git clone <url>*, где *<url>* - ссылка на удаленный репозитарий.
