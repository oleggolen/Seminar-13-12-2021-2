...
Чтобы сделать *pull recuest*  необходимо сделать __*fork*__ нужного репозитория и затем: 

* В своей копии репозитория(в профиле GitHub) скопировать ссылку на репозиторий.
* В локальной папке вызвать команду *git clone* URL
* Создать отдельную ветку в пределах которой будут вноситься изменения
* Зафиксировать состояние файла командой *git commit -am*    
* Отправить на удаленный репозиторий измененный файл командой git push origin <branch_name>
* Нажать кнопочку *pull recuest* в профиле GitHub 