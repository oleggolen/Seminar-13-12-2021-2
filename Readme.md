...
1. Создайте форк проекта (Для того, чтобы создать ответвление проекта, зайдите на страницу проекта и нажмите кнопку *Fork (Создать ответвление)*, которая расположена в правом верхнем углу.
...
5. Откройте запрос на слияние на GitHub (кнопка *"Pull request"*).
