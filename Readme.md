...
Клонируем репозиторий, используя протокол *git clone + url*

## git pull

Для синхронизации текущей ветки с репозиторием используются команды *git pull*
Она забрает изменения удаленной ветки из репозитория и проводит слияние с активной веткой.

## git push 
После проведения работы в локальном репозитории, необходимо обновить удаленный репозиторий (удаленную ветку). Для этого используется команда *git push.*
